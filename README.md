+ > 原文链接：[https://blog.csdn.net/weixin_44984664/article/details/106874505](https://blog.csdn.net/weixin_44984664/article/details/106874505)

  训练后模型(1.03GB)，百度网盘链接

  [https://pan.baidu.com/s/1y1vzf9RJOM0xMre5ZXy_pQ](https://pan.baidu.com/s/1y1vzf9RJOM0xMre5ZXy_pQ) 
  提取码：5xq3
  ...
  $$
  pearson\;baseline\;sim(u,v)= \hat { \rho } _ { u v } = \frac { \sum _ { i \in I _ { u v } } ( r _ { u i } - b _ { u i } ) \cdot ( r _ { v i } - b _ { v i } ) } { \sqrt { \sum _ { i \in I _ { u v } } ( r _ { u i } - b _ { u i } ) ^ { 2 } } \cdot \sqrt { \sum _ { i \in I _ { u v } } ( r _ { v i } - b _ { v i } ) ^ { 2 } } }
  $$


  $$
  pearson\;baseline\;shrunk\;sim(u,v)=  \frac { | I _ { u v } | - 1 } { | I _ { u v } | - 1 + \text { shrinkage } } \cdot \hat { \rho } _ { u v }
  $$
  ...
  ![\[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-CjPZcws3-1592643015936)(https://www.showdoc.cc/server/api/common/visitfile/sign/bbc7b100011879f23b07aacd4dd43236?showdoc=.jpg)\]](https://img-blog.csdnimg.cn/20200620165641685.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDk4NDY2NA==,size_16,color_FFFFFF,t_70)
